...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter{
   ...
   protected void configure(HttpSecurity http) throws Exception {
       ...
       http.authorizeRequests()
            ...
            .antMatchers(HttpMethod.GET,"/api/v1/payment").hasRole("USER")
            .antMatchers(HttpMethod.POST,"/api/v1/payment").hasRole("USER")
            .antMatchers(HttpMethod.PUT,"/api/v1/payment").hasRole("USER")
            .antMatchers(HttpMethod.DELETE,"/api/v1/payment").hasRole("USER")
            .antMatchers(HttpMethod.POST, "/api/v1/product").hasRole("ADMIN")
            .antMatchers(HttpMethod.DELETE, "/api/v1/product").hasRole("ADMIN")
            .antMatchers(HttpMethod.PUT, "/api/v1/product").hasRole("ADMIN")
            ...
            .antMatchers(HttpMethod.POST, "/api/v1/order").hasRole("USER")
            .antMatchers(HttpMethod.DELETE, "/api/v1/order").hasRole("USER")
